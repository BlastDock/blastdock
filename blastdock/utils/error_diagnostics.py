...
class ErrorDiagnostics:
    ...
    def diagnose_error(
        self, exception: Exception, operation_context: Dict[str, Any] = None
    ) -> ErrorContext:
    ...
    def _check_network_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "local_docker": check_connectivity("localhost", 2375)
                or check_connectivity("localhost", 2376),
            }
        except Exception as e:
            return {"error": str(e)}
    ...
    def _get_recovery_commands(
        ...
        if "Docker" in error_type:
            commands.extend(
                ["docker --version", "docker info", "sudo systemctl status docker"]
            )
        elif "Traefik" in error_type:
            commands.extend(
                [
            ...
            commands.extend(
                ["blastdock templates list", "blastdock templates validate"]
            )
        elif "Port" in error_type:
            commands.extend(
                ["blastdock ports list", "blastdock ports conflicts", "netstat -tuln"]
            )
        elif "Domain" in error_type:
            commands.extend(
                ["blastdock domain list", "nslookup <domain>", "dig <domain>"]
            )
    ...
    def _load_recovery_strategies(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            "DockerNotAvailableError": {
                ...
                "quick_fixes": ["sudo systemctl start docker", "docker --version"],
            },
            ...
            "TemplateNotFoundError": {
                ...
                "quick_fixes": ["blastdock templates list"],
            },
            "PortConflictError": {
                "solutions": [
    ...
    def _check_disk_space_sufficient(
        self, min_free_gb: float = 1.0
    ) -> Tuple[bool, str]:
        ...
        try:
            ...
            if free_gb >= min_free_gb:
                ...
                return (
                    False,
                    f"Only {free_gb:.1f}GB free space (minimum {min_free_gb}GB required)",
                )
        except Exception as e:
    ...
    def suggest_recovery_actions(
        ...
        actions = {"immediate": [], "short_term": [], "preventive": []}
