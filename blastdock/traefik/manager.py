...
class TraefikManager:
    ...
    def is_running(self) -> bool:
        ...
        try:
            ...
            for container in containers:
                if (
                    container.get("name") == self.TRAEFIK_CONTAINER_NAME
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        if status["running"]:
            try:
                ...
                container_info = self.docker_client.get_container_info(
    ...
    def create_network(self) -> bool:
        ...
        try:
            self.docker_client.create_network(
                self.TRAEFIK_NETWORK, driver="bridge", attachable=True
            )
    ...
    def get_dashboard_url(self) -> Optional[str]:
        ...
        try:
            ...
            dashboard_domain = traefik_config.get(
                "dashboard_domain", "traefik.blastdock.local"
            )
    ...
    def get_logs(self, follow: bool = False, tail: int = 100) -> str:
        ...
        try:
            return self.docker_client.get_container_logs(
                self.TRAEFIK_CONTAINER_NAME, follow=follow, tail=tail
            )
        except Exception as e:
        ...
        try:
            ...
            if self.is_installed():
                ...
                self.docker_client.remove_container(
                    self.TRAEFIK_CONTAINER_NAME, force=True
                )
