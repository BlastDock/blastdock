...
class DockerConfig(BaseModel):
    ...
    default_restart_policy: str = Field(
        default="unless-stopped", description="Default restart policy"
    )
    ...
    traefik_cert_resolver: str = Field(
        default="letsencrypt", description="Traefik certificate resolver"
    )
...
class BlastDockConfig(BaseModel):
    ...
    default_domain: str = Field(
        default="localhost", description="Default domain for auto-subdomains"
    )
