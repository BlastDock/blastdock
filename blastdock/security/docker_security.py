...
class DockerSecurityChecker:
    ...
    def __init__(self):
        ...
        self.UNSAFE_REGISTRIES = {"localhost", "127.0.0.1", "docker.io/malicious"}
    ...
    def check_container_security(self, container_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            dangerous_caps = [
                cap for cap in cap_add if cap in self.DANGEROUS_CAPABILITIES
            ]
            if dangerous_caps:
                security_issues.append(
                    {
        ...
        try:
            ...
            return {
                ...
                "metadata": {
                    ...
                    "tags": repo_tags,
                    "exposed_ports": (
                        list(exposed_ports.keys()) if exposed_ports else []
                    ),
                },
            }
    ...
    def check_docker_daemon_security(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if result.returncode != 0:
                return {"accessible": False, "error": result.stderr.strip()}
            ...
            insecure_registries = docker_info.get("RegistryConfig", {}).get(
            ...
            return {"accessible": False, "error": f"Failed to get Docker info: {e}"}
    ...
    def scan_docker_compose_security(self, compose_content: str) -> Dict[str, Any]:
        ...
        if not isinstance(compose_data, dict):
            return {"valid": False, "error": "Compose file must be a dictionary"}
